...
import { responsive, widthScreen, percent } from '../../res/responsive';

const HimnoHome = (props) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                <Text style={styles.textFooter}> Version 1.7.1.  By JAsbel </Text>
            </View>
        </View>
    )
}
